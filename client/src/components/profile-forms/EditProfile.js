...
const EditProfile = ({
  ...
  useEffect(() => {
    ...
    setFormData({
      typeofart: loading || !profile.typeofart ? "" : profile.typeofart,
  ...
  return (
    <Fragment>
      ...
      <p className="lead">
        <i className="fas fa-user-edit"></i> {user && user.name}, update your
        profile
      </p>
      ...
      <form className="form" onSubmit={(e) => onSubmit(e)}>
        ...
        <div className="form-group">
          ...
          />
          <small className="form-text">
            * What can you do? (use comma to separate your skills: ex.
            drawing,sewing,knitting,carving,molding, etc.)
          </small>
        </div>
        <div className="form-group">
          <textarea
